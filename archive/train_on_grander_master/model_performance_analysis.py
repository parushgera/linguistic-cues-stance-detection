...
def run_performance_analysis(base_dir, total_iterations=13):
    ...
    print(f"📊 Summary statistics saved to: model_performance_summary.csv")
...
if __name__ == "__main__":
    # Configuration
    base_dir = "evaluation_results"  # Directory containing the data files
    
    # Run analysis
    results_df, summary_stats = run_performance_analysis(base_dir)
