...
def main():
    ...
    comparison_dir = RESULTS_DIR / "comprehensive_shap_analysis" / "shap_linear_comparison_final"
    shap_dir = RESULTS_DIR / "comprehensive_shap_analysis" / "final_shap_aggregated"
    output_dir = RESULTS_DIR / "quartile_analysis_final"
